...
You're in luck! The `your_code_is_trash` package can help you
get this done.

Download the code from this GitHub repository and place
the `your_code_is_trash/` folder in the same directory as your
Python script:
...
`add()` function from the `your_code_is_trash.calculator`
module:

    # your_script.py
    from your_code_is_trash.calculations import add
